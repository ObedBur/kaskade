    ...
    <div className="">
      <header className="flex flex-col md:flex-row justify-between items-start md:items-center mb-16 gap-8">
        ...
        <div className="flex flex-wrap gap-4 w-full md:w-auto">
          ...
          <button className="flex-1 md:flex-none justify-center bg-[#BC9C6C] text-white px-8 py-4 rounded-3xl font-bold flex items-center gap-3 text-sm shadow-xl shadow-[#BC9C6C]/10 hover:shadow-[#BC9C6C]/20 transition-all active:scale-95">
