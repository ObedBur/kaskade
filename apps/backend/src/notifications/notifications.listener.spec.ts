...
describe('NotificationsListener', () => {
  ...
  describe('Provider Application', () => {
    it('handleProviderApplied targets admins and client', async () => {
      ...
      mockNotificationsService.createManyNotifications.mockResolvedValue([
        { id: 'n2', userId: 'admin1' },
      ]);
      prisma.user.findMany.mockResolvedValue([{ id: 'admin1' }]);
      await listener.handleProviderApplied({
        userId: 'u1',
        applicationId: 'app1',
      });
      expect(notificationsService.createNotification).toHaveBeenCalled();
    ...
    it('handleProviderApplicationResolved - APPROVED', async () => {
      ...
      await listener.handleProviderApplicationResolved({
        userId: 'u1',
        status: 'APPROVED',
        applicationId: 'app1',
      });
      expect(notificationsService.createNotification).toHaveBeenCalled();
      expect(
        notificationsService.createNotification.mock.calls[0][0].title,
      ).toContain('Acceptée');
    });
  ...
  describe('Service Management', () => {
    it('handleServiceCreated with clients', async () => {
      ...
      await listener.handleServiceCreated({
        serviceId: 's1',
        serviceName: 'Serv',
      });
      expect(notificationsService.createManyNotifications).toHaveBeenCalled();
    ...
    it('handleServiceCreated without clients', async () => {
      ...
      expect(
        notificationsService.createManyNotifications,
    ...
    it('handleServiceUpdated', async () => {
      ...
      await listener.handleServiceUpdated({
        serviceId: 's1',
        serviceName: 'Serv',
      });
      expect(notificationsService.createManyNotifications).toHaveBeenCalled();
  ...
  describe('Request Workflow', () => {
    ...
    it('handleRequestApproved with providers', async () => {
      ...
      await listener.handleRequestApproved({
        requestId: 'r1',
        serviceId: 's1',
      });
      expect(notificationsService.createManyNotifications).toHaveBeenCalled();
    ...
    it('handleRequestAccepted', async () => {
      ...
      await listener.handleRequestAccepted({
        requestId: 'r1',
        clientId: 'c1',
        providerId: 'p1',
      });
    ...
    it('handleRequestRejected', async () => {
      ...
      await listener.handleRequestRejected({
        requestId: 'r1',
        providerId: 'p1',
      });
      expect(notificationsService.createManyNotifications).toHaveBeenCalled();
  ...
  describe('Payment and Completion', () => {
    ...
    it('handleRequestCompleted', async () => {
      ...
      await listener.handleRequestCompleted({
        requestId: 'r1',
        providerId: 'p1',
      });
      expect(notificationsService.createManyNotifications).toHaveBeenCalled();
