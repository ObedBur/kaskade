...
export default function ProfilPage() {
  ...
  const handleFileChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      toast.success("Photo chargée. Cliquez sur Enregistrer pour valider.");
    } catch (err: any) {
      ...
      <form onSubmit={handleSubmit} className="grid grid-cols-1 xl:grid-cols-12 gap-16">
        ...
        <div className="xl:col-span-4 space-y-12">
          <div className="bg-white border border-[#321B13]/5 p-12 text-center flex flex-col items-center group">
            {/* Zone cliquable pour changer l'avatar */}
            <div
            ...
            >
              ...
              {/* Overlay hover */}
              <div className="absolute inset-0 bg-[#321B13]/40 flex flex-col items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity z-20 gap-2">
            ...
            <h3 className="text-2xl font-black text-[#321B13] uppercase tracking-tighter mb-2">
              {user?.fullName}
            </h3>
            ...
            <div className="w-full space-y-4 pt-8 border-t border-[#321B13]/5">
              ...
              <div className="flex items-center gap-3 text-[#321B13]/60">
                ...
                <span className="text-xs font-bold">
                  {formData.quartier || "Non renseigné"}
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-[#321B13] p-10 text-white space-y-6">
            <h4 className="text-[10px] font-black uppercase tracking-[0.3em] text-[#BC9C6C]">
              Réviser mon profil
            </h4>
            <p className="text-xs text-white/50 leading-relaxed font-medium">
              Votre profil est la première image que les clients et
              l&apos;administration ont de votre expertise. Soyez précis et
              professionnel dans vos descriptions.
            </p>
          </div>
        </div>
        ...
        <div className="xl:col-span-8 space-y-12">
          ...
          <div className="pt-8 flex justify-end">
            <button
              ...
              className="bg-[#321B13] text-[#FCFBF7] px-12 py-5 text-xs font-black uppercase tracking-[0.2em] flex items-center gap-3 hover:bg-[#BC9C6C] hover:text-[#321B13] transition-all disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {loading ? (
