  ...
  const topCards = [
    {
      title: "Revenue",
      value: hasUSD
        ? `${revenue.USD.toLocaleString("fr-FR")} $`
        : hasCDF
          ? `${revenue.CDF.toLocaleString("fr-FR")} FC`
          : "0 FC",
      sub:
        hasUSD && hasCDF
          ? `+ ${revenue.CDF.toLocaleString("fr-FR")} FC`
    ...
    },
    {
      ...
      sub: `${stats?.requests.pending || 0} en attente`,
      icon: MessageSquare,
      color: "text-blue-600",
    },
    {
        ...
        {topCards.map((card, index) => (
          ...
          >
            <div className="flex justify-between items-start">
              <div
                className={`p-2 bg-gray-50 rounded-none group-hover:scale-110 transition-transform`}
              >
            ...
            <div>
              <h3 className="text-2xl font-black text-[#321B13]">
                {card.value}
              </h3>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
        ...
        <div className="lg:col-span-2 bg-white border border-gray-100 shadow-sm p-8 flex flex-col">
          <div className="flex justify-between items-center mb-8 pb-4 border-b border-gray-50">
            <h2 className="text-xs font-black uppercase tracking-[0.3em] text-[#321B13]">
              Dernières Demandes
            </h2>
            <Link
              href="/admin/requests"
              className="text-[9px] font-bold text-[#BC9C6C] hover:underline uppercase tracking-widest"
            >
              Voir tout
            </Link>
          </div>
          <div className="space-y-6 h-[380px] overflow-y-auto pr-2 custom-scrollbar">
            {activity?.recentRequests.map((req, i) => (
              <div
                key={i}
                className="flex items-start gap-4 p-4 hover:bg-gray-50 transition-colors group border-b border-gray-50 last:border-0"
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex justify-between items-center mb-1">
                    <p className="text-[11px] font-black text-[#321B13] truncate uppercase">
                      {req.service?.name}
                    </p>
                    <span
                      className={`text-[8px] font-bold px-2 py-0.5 rounded-none uppercase tracking-tighter ${
                        req.status === "PENDING"
            ...
            {(!activity?.recentRequests ||
              ...
              <div className="py-20 text-center text-gray-400 text-[10px] uppercase tracking-widest">
          ...
          <div className="space-y-6 h-[380px] overflow-y-auto pr-2 custom-scrollbar">
            {activity?.recentUsers.map((u, i) => (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-[11px] font-black text-[#321B13] uppercase">
                    {u.fullName}
                  </p>
        ...
        <div className="lg:col-span-1 bg-white border border-gray-100 shadow-sm p-8 flex flex-col">
          <h2 className="text-xs font-black uppercase tracking-[0.3em] text-[#321B13] mb-8 pb-4 border-b border-gray-50 w-full text-left">
            Résumé
          </h2>
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="w-full bg-gray-50 h-[3px]">
                <div
                  ...
                  style={{
                    width: `${((stats?.requests.completed || 0) / (stats?.requests.total || 1)) * 100}%`,
                  }}
                ></div>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="w-full bg-gray-50 h-[3px]">
                <div
                  ...
                  style={{
                    width: `${((stats?.requests.inProgress || 0) / (stats?.requests.total || 1)) * 100}%`,
                  }}
                ></div>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="w-full bg-gray-50 h-[3px]">
                <div
                  ...
                  style={{
                    width: `${((stats?.requests.pending || 0) / (stats?.requests.total || 1)) * 100}%`,
                  }}
                ></div>
              </div>
            </div>
      ...
      <div className="w-full bg-[#321B13] text-white p-16 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col md:flex-row justify-between items-center gap-12">
          <div className="max-w-2xl">
            <span className="text-[#BC9C6C] font-black tracking-[0.4em] text-[10px] uppercase mb-6 block">
              System Performance
            </span>
            <h2 className="text-4xl font-black uppercase tracking-tighter leading-[0.9] mb-6">
              REDÉFINISSEZ <br />{" "}
              <span className="text-[#BC9C6C] italic serif lowercase">
          ...
          <div className="flex gap-6">
            <div className="p-10 border border-white/10 bg-white/5 text-center min-w-[160px]">
              ...
              <p className="text-[9px] font-black uppercase tracking-[0.3em] text-[#BC9C6C] mt-2">
                Membres
              </p>
            </div>
            <div className="p-10 border border-white/10 bg-white/5 text-center min-w-[160px]">
